...
- **RB-002** — Conditional Access blocking legitimate users
- **RB-003** — SAML SSO assertion failure
- **RB-004** — MFA registration lockout
- **RB-005** — AD user not appearing in Entra
 
## How to use
 
1. Download `sso-labs-runbooks.html`
